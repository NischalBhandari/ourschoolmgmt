...
class ExceptionListener implements EventSubscriberInterface 
{
    ...
    public function __construct(ErrorController $controller, LoggerInterface $logger = null, bool $debug = false)
    {
    ...
    public function onKernelException(ExceptionEvent $event)
    {
        if (null === $this->controller) {
            $this->logger->error("no controller defined");
            return ;
        }
        $this->logger->error("Controller define");
